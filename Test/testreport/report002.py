...
class woshidai(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.driver.set_window_size(1760, 1040)
    ...
    def test_VIP(self):
        ...
        driver = self.driver
        driver.get(self.url)
        driver.find_element_by_css_selector("[href=/member/institution/index]").click()
        time.sleep(5)
...
if __name__ == "__main__":
    ...
    suite.addTest(woshidai("test_VIP"))

    # 按照一定格式获取当前时间
    now = time.strftime("%Y_%m_%d %H:%M:%S")

    # 定义报告存放路径
    filename = r'./result432.html'
